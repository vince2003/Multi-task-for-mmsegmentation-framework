...
def parse_args():
    ...
    parser.add_argument(
        '--training_path', default='./data/training.zip', help='the training part of DRIVE dataset')
    parser.add_argument(
        '--testing_path', default='./data/test.zip', help='the testing part of DRIVE dataset')
    parser.add_argument('--tmp_dir', default='./tmp', help='path of the temporary directory')
    parser.add_argument('-o', '--out_dir', default='./result', help='output path')
